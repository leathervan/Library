...
<div class="position-absolute bottom-0 end-0">
    <nav>
        <ul class="pagination justify-content-center">
            <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/adminCustomers?sessionLocale=en">en</a></li>
            <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/adminCustomers?sessionLocale=ru">ru</a></li>
        </ul>
    </nav>
</div>
